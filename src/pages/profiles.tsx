...
const ProfilePage = () => {
  ...
  const mutateLogs = useCallback(async () => undefined, [])
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <Tooltip title={t('profiles.page.actions.import')} arrow>
          <span>
            <LoadingButton
              ...
              variant="contained"
              size="small"
              aria-label={t('profiles.page.actions.import')}
              sx={(theme) => ({
                minWidth: 36,
                width: 36,
                height: 36,
        ...
        <Tooltip title={t('shared.actions.new')} arrow>
          <IconButton
            size="small"
            color="primary"
            aria-label={t('shared.actions.new')}
            sx={(theme) => ({
              width: 36,
              height: 36,
              borderRadius: 1.5,
