...
export const WindowProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  useEffect(() => {
    currentWindow.setTitle('Celestial').catch((err) => {
      console.warn('[WindowProvider] failed to set title:', err)
    })
    currentWindow
      .setDecorations(false)
      .then(() => setDecorated(false))
      .catch((err) => {
        console.warn('[WindowProvider] failed to disable decorations:', err)
        refreshDecorated()
      })
