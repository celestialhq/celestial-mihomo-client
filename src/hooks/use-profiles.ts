...
export const useProfiles = () => {
  ...
  // Re-applying the profile's saved node choices lives in the backend now: it has to run
  // on a core start as well as on a profile switch, and this hook is not mounted then.
  return {
    profiles,
