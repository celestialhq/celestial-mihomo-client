...
// 本地存储的键名
const STORAGE_KEY_GROUP = 'celestial-selected-proxy-group'
const STORAGE_KEY_PROXY = 'celestial-selected-proxy'
const STORAGE_KEY_SORT_TYPE = 'celestial-proxy-sort-type'
