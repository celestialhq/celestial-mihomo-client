...
const TASK_NAME_USER: &str = "Celestial";
const TASK_NAME_ADMIN: &str = "Celestial (Admin)";
const TASK_XML_DIR: &str = "tasks";
const TASK_XML_USER: &str = "celestial-task-user.xml";
const TASK_XML_ADMIN: &str = "celestial-task-admin.xml";
