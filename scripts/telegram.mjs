...
async function sendTelegramNotification() {
  ...
  const downloadUrl =
    ...
    `https://github.com/${process.env.RELEASE_REPO || 'celestialhq/celestial-mihomo-client'}/releases/download/v${version}`
  ...
  const publicReleaseRepo =
    process.env.RELEASE_REPO || 'celestialhq/celestial-mihomo-client'
